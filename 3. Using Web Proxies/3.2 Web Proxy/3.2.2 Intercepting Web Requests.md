...
![Proxy tab with Intercept, HTTP history, WebSockets history, and Options. Buttons: Forward, Drop, Intercept is on, Action, Open Browser.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intercept_htb_on.png)
...
![Proxy tab showing HTTP request details with buttons: Forward, Drop, Intercept is on, Action, Open Browser.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intercept_page.png)
...
![Toolbar with various icons and 'Standard Mode' dropdown, 'Sites' section with a plus icon.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/zap_intercept_htb_on.jpg)
...
![HTTP request details with 'Request' and 'Break' buttons, method, header, and body dropdowns.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/zap_intercept_page.png)
...
![Toolbar with icons, 'Standard Mode' dropdown, and 'Sites' section with a plus icon.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/zap_enable_HUD.jpg)
...
![Ping interface with IP input '127.0.0.0', Ping button, and side controls for sites, start, and status indicators.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/zap_hud_break.jpg)
...
![HTTP Message dialog showing request details with buttons: Step, Continue, Drop.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/zap_hud_break_request.png)
...
Content-Length: 4 Cache-Control: max-age=0 
...
Referer: http://94.237.62.138:32306/ Accept-Encoding: gzip, deflate, br Connection: keep-alive 
...
![HTTP Message dialog showing POST request details with buttons: Step, Continue, Drop.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/ping_manipulate_request.png)
...
![List of files: flag.txt, index.html, node_modules, package-lock.json, public, server.js.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/ping_inject.jpg)
