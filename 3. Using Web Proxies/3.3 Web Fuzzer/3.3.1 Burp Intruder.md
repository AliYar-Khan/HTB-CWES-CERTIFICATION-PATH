...
![Intruder tab showing Attack Target configuration with host 46.101.23.188 and port 31827, option to use HTTPS.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_target.png)
...
![Intruder tab showing Payload Positions with attack type Sniper, displaying HTTP GET request details.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_position.png)
...
![Intruder tab showing Payload Sets configuration with payload set 1, type Simple list, and counts for payload and request.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_payload_set.png)
...
![Payload Options for Simple list with file names, buttons for Paste, Load, Remove, Clear, and Add new item.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_payload_wordlist.png)
...
![Payload processing rule dialog with option 'Skip if matches regex' and regex pattern '^..*$', OK and Cancel buttons.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_payload_processing_1.jpg)

We can see that our rule gets added and enabled: ![Payload Processing with rule 'Skip if matches ^..*$', buttons for Add, Edit, Remove, Up, Down.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_payload_processing_2.png)
...
![Grep - Match settings to flag items with expressions. Example: '200 OK'. Options: Simple string, Regex, Case sensitive, Exclude HTTP headers.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_options_match.png)
...
![Results table showing requests with payloads, all with status 404, length 458.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_attack_exclude.png)
...
![Results table showing requests. 'admin' payload has status 200, length 244, marked 200 OK. Others have status 404, length 458.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_intruder_attack.png)
