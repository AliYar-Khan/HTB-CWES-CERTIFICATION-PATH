...
![Proxy HTTP history showing requests. Selected GET request to http://142.93.35.92:30269/ with status 200, length 11297, HTML. Context menu options include 'Scan'](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_scan_request.jpg)
...
![Target site map showing directory structure for http://46.101.23.188:30760. Selected GET request to '/' with status 200, length 11315, HTML, title 'HTB Academy'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_site_map_before.jpg)

To add an item to our scope, we can right-click on it and select `Add to scope`:

![Context menu for http://46.101.23.188:30760l with option to 'Add to scope'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_add_to_scope.jpg)
...
![Target Scope settings with 'Include in scope' for http://142.93.35.92:30269/ and 'Exclude from scope' for /xmlrpc.php. 'Use advanced scope control' is unchecked.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_target_scope.jpg)
...
![Scan details with 'Crawl' selected. URL to scan: http://142.93.35.92:30269/. Protocol settings: Scan using HTTP & HTTPS.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_new_scan.jpg)
...
![Table of crawl configurations with names like 'Crawl limit - 10 minutes' and 'Crawl strategy - fastest'. All marked as built-in.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_crawl_config.jpg)
...
![Dashboard showing a task for crawling 46.101.23.188:30760 with 'fastest' strategy. Progress: 76 requests, 2 errors, 10 locations crawled, 4s remaining.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_crawl_progress.jpg)
...
![Site map for http://46.101.23.188:30760 showing directories like 'devtools' and 'index.php'. Contents list GET requests with status 200, HTML, and titles like 'HTB Academy'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_site_map_after.jpg)
...
![Issue activity table showing issues like 'Cookie without HttpOnly flag set' and 'Frameable response (potential Clickjacking)'. Severity: Information. Confidence: Certain or Firm.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_passive_scan.jpg)
...
![Dashboard showing a running task for crawl and audit of 142.93.35.92:32729. Audit checks for critical issues only. Progress: 3749 requests, 10 errors, 28 locations crawled, 1h 16m remaining.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_active_scan.jpg)
...
![Logger showing captured GET requests to 142.93.35.92. Paths include '/index.php/search/18508'. Status: 404. Capture filter: memory limit 100MB, requests and responses up to 1MB.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_logger.jpg)
...
![Issue activity showing OS command injection on host http://142.93.35.92:32729l. Insertion point: ip parameter. Severity: High. Confidence: Firm.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_high_vulnerabilities.jpg)
...
![OS command injection issue with high severity and firm confidence on host http://142.93.35.92:32729. Details mention vulnerability to command injection using pipe character.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_vuln_details.jpg)
...
![Burp Scanner Report summary table showing issue counts by severity and confidence. High: 1 firm. Medium: 0. Low: 1 certain. Information: 2 certain, 3 firm. Total issues: 5.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_scan_report.jpg)
