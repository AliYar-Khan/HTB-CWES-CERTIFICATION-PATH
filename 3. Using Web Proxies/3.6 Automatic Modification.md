...
![Rule settings for 'HTB User-Agent', matching 'User-Agent' in request header, replacing with 'HackTheBox Agent 1.0', enabled, Save and Cancel buttons.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/zap_match_replace_user_agent_1.png)
...
![HTTP request details with 'User-Agent: HackTheBox Agent 1.0' highlighted.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/zap_match_replace_user_agent_2.png)
...
![Ping interface with IP input '127.0.0.0' and 'Ping' button.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/110/burp_match_replace_response_2.jpg)
