...
```shellsession
aliyark145@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git aliyark145@htb[/htb]$ cd FinalRecon 
aliyark145@htb[/htb]$ pip3 install -r requirements.txt 
aliyark145@htb[/htb]$ chmod +x ./finalrecon.py 
aliyark145@htb[/htb]$ ./finalrecon.py --help 
...
```shellsession
aliyark145@htb[/htb]$ ./finalrecon.py --headers --whois --url http://inlanefreight.com  
