...
```shellsession
aliyark145@htb[/htb]$ dig google.com 
...
;; WHEN: Thu Jun 13 10:45:58 SAST 2024 ;; MSG SIZE rcvd: 54
```
...
aliyark145@htb[/htb]$ dig +short hackthebox.com 
104.18.20.126 
104.18.21.126
```
...
solution 1: dig inlanefreight.com gives the IP address

solution 2: nslookup ip address gives the PTR record

solution 3: dig facebook.com mx gives the domain