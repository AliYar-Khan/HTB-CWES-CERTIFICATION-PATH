...
```shellsession
aliyark145@htb[/htb]$ curl http://SERVER_IP:PORT/serial.php -X POST -d "param1=sample" 
...
```shellsession
aliyark145@htb[/htb]$ echo https://www.hackthebox.eu/ | base64
...
```shellsession
aliyark145@htb[/htb]$ echo aHR0cHM6Ly93d3cuaGFja3RoZWJveC5ldS8K | base64 -d
...
```shellsession
aliyark145@htb[/htb]$ echo https://www.hackthebox.eu/ | xxd -p
...
```shellsession
aliyark145@htb[/htb]$ echo 68747470733a2f2f7777772e6861636b746865626f782e65752f0a | xxd -p -r
...
```shellsession
aliyark145@htb[/htb]$ echo https://www.hackthebox.eu/ | tr 'A-Za-z' 'N-ZA-Mn-za-m' 
...
```shellsession
aliyark145@htb[/htb]$ echo uggcf://jjj.unpxgurobk.rh/ | tr 'A-Za-z' 'N-ZA-Mn-za-m' 
...
String `N2gxNV8xNV9hX3MzY3IzN19tMzU1NGcz` was identified as base64. Decoding it gives `7h15_15_a_s3cr37_m3554g3`.  Sending it as post request data gives `HTB{ju57_4n07h3r_r4nd0m_53r14l}`.