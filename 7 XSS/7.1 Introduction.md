...
---
XSS stands for Cross Site Scripting and basically it is a vulnerability in user input sanitization allowing user to add malicious JavaScript to be executed on client side leading to several types of attacks.
...
![Risk matrix with axes: Probability (low to high) and Impact (low to high), showing strategies: Reduce, Avoid, Accept, Transfer.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/103/xss_risk_chart_1.jpg)
