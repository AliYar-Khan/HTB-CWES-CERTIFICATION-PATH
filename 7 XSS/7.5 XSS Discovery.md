...
```shellsession
aliyark145@htb[/htb]$ git clone https://github.com/s0md3v/XSStrike.git aliyark145@htb[/htb]$ cd XSStrike 
aliyark145@htb[/htb]$ pip install -r requirements.txt 
aliyark145@htb[/htb]$ python xsstrike.py 
...
aliyark145@htb[/htb]$ python xsstrike.py -u "http://SERVER_IP:PORT/index.php?task=test"          
...
Question 1: send register request and use xss strike to check and it returns `email`

Question 2: Answer is `Reflected`
