...
![Search interface with a text box and button labeled 'Search'. Below is a table with columns: Port Code, Port City, and Port Volume. Entries include AE DXB, Dubai, 15.73 and BR SSZ, Santos, 3.6](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/33/order_by_2.jpg)
...
![Search interface with a text box and button labeled 'Search'. Below is a table with columns: Port Code, Port City, and Port Volume. An error message states: Unknown column '5' in 'order clause](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/33/order_by_5.jpg)
...
![Search interface with a text box and button labeled 'Search'. Below is a table with columns: Port Code, Port City, and Port Volume. An error message states: The used SELECT statements have a different number of columns](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/33/ports_columns_diff.png)
...
![Search interface with a text box and button labeled 'Search'. Below is a table with columns: Port Code, Port City, and Port Volume. Entries include 2, 3, and 4](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/33/ports_columns_correct.png)
...
![Search interface with a text box and button labeled 'Search'. Below is a table with columns: Port Code, Port City, and Port Volume. Entry includes 10.3.22-MariaDB-1ubuntu1, 3, and 4](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/33/db_version_1.jpg)
...
found the user to be `root@localhost`